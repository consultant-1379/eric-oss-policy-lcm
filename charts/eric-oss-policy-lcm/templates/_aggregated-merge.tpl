...
*/ -}}
{{- define "eric-oss-policy-lcm.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-policy-lcm.mergeAnnotations" -}}
  {{- include "eric-oss-policy-lcm.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-policy-lcm.mergeLabels" -}}
  {{- include "eric-oss-policy-lcm.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
